...
function wpbootstrap_scripts_with_jquery()
{
	...
	wp_register_script( 'jqueryUI-language-script', "http://jquery-ui.googlecode.com/svn/tags/latest/ui/minified/i18n/jquery-ui-i18n.min.js", array(), null, false);
	wp_enqueue_script( 'jqueryUI-language-script' );

	wp_enqueue_style( 'jqueryTimepicker-css', get_template_directory_uri().'/assets/jquery-timepicker/jquery.timepicker.css' );
	wp_register_script( 'jqueryTimepicker-script', get_template_directory_uri().'/assets/jquery-timepicker/jquery.timepicker.js', array(), null, false);
	wp_enqueue_script( 'jqueryTimepicker-script' );
}
