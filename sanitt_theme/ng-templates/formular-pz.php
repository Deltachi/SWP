						...
						<table>
							<tbody>
								...
								<tr class="padding-top">
									...
									<td>
										<select name="exam_data_name" ng-model="register_data.exam_data.name" ng-init="register_data.exam_data.name = exams[activeExam].version[0].name">
								...
								<tr ng-if="exams[activeExam].requirements">
									...
									<td colspan="2" ng-if="activeExam.indexOf('CTAL') > -1">
										<div><small>
											...
											in einer gut lesbaren Kopie im PDF-Format an: <strong>pruefungszentrum@sanitt.de</strong> <br>
											<ul>
												<li>Zusendung des unterschriebenen Antrags im PDF-Format: <a href="http://www.avanta-pruefungszentrum.de/download/Anmeldung_ISTQB.pdf" target="_blank">Antragsformular</a></li>
								...
								<tr class="padding-bottom">
									...
									<td>
										<input type="time" name="exam_data_time1" ng-model="register_data.exam_data.time1" placeholder="z.B. 11:00 (vorangestellte 0 mit angeben!)" min="08:00" max="17:00" required />
									</td>
								...
								<tr class="padding-top" ng-init="register_data.exam_members.push({'gender':'female','student':'false','timebonus':'false'})">
									...
									<td>(Aktuell: {{register_data.exam_members.length}} Teilnehmer) <br> <a class="pointer" ng-click="register_data.exam_members.pop()">Letzten Teilnehmer entfernen</a> </td>
									<td></td>
								</tr>
