<nav id="fixed-navigation" class="fixed hidden fade-out">
					...
					<ul class="navigation-bar">
						...
						<li class="item toggleable" ng-class="tabContains('it-pz',activeTab) == true ? 'active-page':''"><a>IT-Prüfungszentrum <img class="glyphicon"  ng-src="{{wp_templateUrl}}/images/icons/chevron_down.svg" alt=""></a>
							<ul style="min-width: 179px;">
								...
								<li class="item toggleable"><a href="/isaqb/">iSAQB<!--  <img class="glyphicon" ng-src="{{wp_templateUrl}}/images/icons/chevron_right.svg" alt=""> --></a>
									<!-- <ul>
										<li class="item"><a href="/">Anmeldung</a></li>
			...
			<div id="menu-hide-seperate"><a class="hide-btn"><img ng-src="{{wp_templateUrl}}/images/icons/chevron_down_white.svg" alt=""></a></div>