								...
								<tbody>
									...
									<tr class="padding-top">
										...
										<td>
											...
											<p><strong>{{register_data.course_data.topic}}</strong></p>
										</td>
										<td></td>
									</tr>
									<tr>
										...
										<td>																				
											<!-- <select name="course_data_name" ng-model="register_data.course_data.name2">
											...
											<!-- <select name="course_data_name" id="course_data_name" ng-options="course as course.name for course in courses[activeTopic].list" ng-model="register_data.course_data.name"></select> -->
											<p><strong>{{register_data.course_data.name}}</strong></p>
										</td>
										<td></td>
									</tr>
									...
									<tr class="padding-top" ng-init="register_data.course_members.push({'gender':'female'})">
										...
										<td>(Aktuell: {{register_data.course_members.length}} Teilnehmer) <br> <a class="pointer" ng-click="removeLastMember();">Letzten Teilnehmer entfernen</a> </td>
										<td></td>
									</tr>
				...
				<div id="confirmation-container" class="overlay-container confirmation-container">
					<div class="inner">
						...
						<p>
							...
							Mail: <a href="mailto:kontakt@sanitt.de">kontakt@sanitt.de</a>
						</p>
