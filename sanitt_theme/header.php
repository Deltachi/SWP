...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?> ng-app="app">
	<head>
		...
		<script type="text/javascript">
			...
			var admin_emails = ['kontakt@sanitt.de','s.jelic@sanitt.de','a.sancar@sanitt.de','dominik.scheffler@me.com'];
			var admin_emails_formatted = admin_emails.join(';');
			// console.log("Admin mails: "+admin_emails_formatted);
		</script>
		<?php wp_head(); ?>
