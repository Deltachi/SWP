...
class wp_it_schulungen_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '
			<section>
				<div class="container it-schulungen">
					<!-- Template for courses created for angular repeat function -->
					<div ng-repeat="course in courses" id="{{course.id}}" class="col-md-12 course-section">
						<button class="collapse-btn" ng-class="{collapsed:!$first}" ng-click="toggleCollapse(course.id);"><strong>{{course.name}}</strong> Schulungen <img class="glyphicon" src="'. $plugin_url .'/images/icons/chevron_down_white.svg" alt=""></button>
						...
						<div class="collapseable" ng-class="{collapsed:!$first}">
							<ng-form name="form_{{course.id}}" action="submit">
								<div class="list padding-before col-md-4 col-sm-4">
								...
								<div class="details-panel padding-before col-md-8 col-sm-8">
									<div class="col-md-12">
				...
				<div id="caution1" class="container">
					<div class="caution animate col-md-12" style="margin-top: 25px; margin-bottom: 25px; border: 1px solid rgb(200,200,200); background-color: rgb(230,230,230); border-radius: 8px; padding: 15px; text-align: center;">
